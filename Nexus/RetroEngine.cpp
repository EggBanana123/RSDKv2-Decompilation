                ...
                if (playerElement) {
                    ...
                    if (plrElement) {
                        do {
                            ...
                            const tinyxml2::XMLAttribute *aniAttr = FindXMLAttribute(plrElement, "animation");
                            const char *plrAni                    = "unknownPlayer.ani";
                            if (aniAttr)
                                plrAni = GetXMLAttributeValueString(aniAttr);
							...
							// Player Anim
							StrCopy(strBuf, plrAni);
							strlen(plrAni);
							strBuf[strLen] = 0;
							
							// Player Script
							strcat(strBuf, plrScript);
							strlen(plrScript);
							strBuf[strLen] = 0;
							
							// Player Name
							strcat(strBuf, plrName);
							strlen(plrName);
